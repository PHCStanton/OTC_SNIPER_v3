...
def generate_report(asset_trades, output_file='auto_ghost_analysis.html'):
    """Generate HTML report with analysis results for Auto-Ghost Trader only"""
    # Create combined data only from ghost trades
    combined_data = {}
    all_assets = set(asset_trades.keys())
    ...
    for asset in all_assets:
        combined_data[asset] = {
            ...
            'total_manipulated': asset_trades[asset]['manipulated_trades'],
    ...
    # Generate HTML with proper string escaping for format()
    html = '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Auto-Ghost Trader Exclusive Analysis Report</title>
...
<body>
    <div class="container">
        <h1>Auto-Ghost Trader Exclusive Analysis Report</h1>
        
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-value">{total_assets}</div>
                <div class="stat-label">Total Assets Traded</div>
            </div>
            <div class="stat-card">
            ...
            <div class="stat-card">
                <div class="stat-value">{avg_profit_per_trade:.2f}</div>
                <div class="stat-label">Average Profit Per Trade ($)</div>
            </div>
        </div>
    ...
    avg_profit_per_trade = total_profit / max(1, total_trades) if total_trades > 0 else 0
    ...
    print(f"Auto-Ghost exclusive report generated successfully: {output_file}")
    print(f"Analyzed {total_assets} assets, {total_trades} total trades")
