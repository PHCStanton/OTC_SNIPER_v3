...
export function validateSettings(input = {}) {
  ...
  return {
    ...
    adaptiveExpiryEnabled: toBoolean(input.adaptiveExpiryEnabled, SETTINGS_DEFAULTS.adaptiveExpiryEnabled),
    ...
    autoGhostAdxGateEnabled: toBoolean(input.autoGhostAdxGateEnabled, SETTINGS_DEFAULTS.autoGhostAdxGateEnabled),
...
export const useSettingsStore = create()(
  persist(
    (set) => ({
      ...
      resetGhostControllerDefaults: () =>
        commitSettingsPatch(set, {
          ghostAmount: SETTINGS_DEFAULTS.ghostAmount,
          autoGhostCopyMode: SETTINGS_DEFAULTS.autoGhostCopyMode,
          autoGhostExpirationSeconds: SETTINGS_DEFAULTS.autoGhostExpirationSeconds,
          autoGhostMaxConcurrentTrades: SETTINGS_DEFAULTS.autoGhostMaxConcurrentTrades,
          autoGhostPerAssetCooldownSeconds: SETTINGS_DEFAULTS.autoGhostPerAssetCooldownSeconds,
          autoGhostMaxSessionTrades: SETTINGS_DEFAULTS.autoGhostMaxSessionTrades,
          autoGhostMaxDrawdownAmount: SETTINGS_DEFAULTS.autoGhostMaxDrawdownAmount,
          autoGhostDrawdownCooldownSeconds: SETTINGS_DEFAULTS.autoGhostDrawdownCooldownSeconds,
          autoGhostMinimumPayout: SETTINGS_DEFAULTS.autoGhostMinimumPayout,
          autoGhostManipulationSeverityThreshold: SETTINGS_DEFAULTS.autoGhostManipulationSeverityThreshold,
          autoGhostBlockOnManipulation: SETTINGS_DEFAULTS.autoGhostBlockOnManipulation,
          ghostWidgetPosition: { x: 0, y: 0 },
          ghostMaxTradesPerTimeframe: SETTINGS_DEFAULTS.ghostMaxTradesPerTimeframe,
          ghostTimeframeSeconds: SETTINGS_DEFAULTS.ghostTimeframeSeconds,
          ghostMinConfidence: SETTINGS_DEFAULTS.ghostMinConfidence,
          ghostMinConfidenceEnabled: SETTINGS_DEFAULTS.ghostMinConfidenceEnabled,
          ghostMaxConfidence: SETTINGS_DEFAULTS.ghostMaxConfidence,
          ghostMaxConfidenceEnabled: SETTINGS_DEFAULTS.ghostMaxConfidenceEnabled,
          ghostMinZScore: SETTINGS_DEFAULTS.ghostMinZScore,
          ghostMinZScoreEnabled: SETTINGS_DEFAULTS.ghostMinZScoreEnabled,
          ghostMaxZScore: SETTINGS_DEFAULTS.ghostMaxZScore,
          ghostMaxZScoreEnabled: SETTINGS_DEFAULTS.ghostMaxZScoreEnabled,
          ghostRegimeGateEnabled: SETTINGS_DEFAULTS.ghostRegimeGateEnabled,
          ghostAllowedRegimes: SETTINGS_DEFAULTS.ghostAllowedRegimes,
          ghostRequireRegimeStable: SETTINGS_DEFAULTS.ghostRequireRegimeStable,
          minAdaptiveExpiry: SETTINGS_DEFAULTS.minAdaptiveExpiry,
          adaptiveExpiryEnabled: SETTINGS_DEFAULTS.adaptiveExpiryEnabled,
          ghostBlacklist: SETTINGS_DEFAULTS.ghostBlacklist,
          autoGhostRsiCciEnabled: SETTINGS_DEFAULTS.autoGhostRsiCciEnabled,
          autoGhostVolatilityGateEnabled: SETTINGS_DEFAULTS.autoGhostVolatilityGateEnabled,
          minVolatilityScore: SETTINGS_DEFAULTS.minVolatilityScore,
          maxVolatilityScore: SETTINGS_DEFAULTS.maxVolatilityScore,
          autoGhostLiquidityGateEnabled: SETTINGS_DEFAULTS.autoGhostLiquidityGateEnabled,
          minLiquidityScore: SETTINGS_DEFAULTS.minLiquidityScore,
          maxLiquidityScore: SETTINGS_DEFAULTS.maxLiquidityScore,
          autoGhostAdxGateEnabled: SETTINGS_DEFAULTS.autoGhostAdxGateEnabled,
          autoGhostCciGateEnabled: SETTINGS_DEFAULTS.autoGhostCciGateEnabled,
          autoGhostBayesianFilterEnabled: SETTINGS_DEFAULTS.autoGhostBayesianFilterEnabled,
          autoGhostBayesianMinProbability: SETTINGS_DEFAULTS.autoGhostBayesianMinProbability,
        }),
      ...
      setAdaptiveExpiryEnabled: (val) => commitSettingsPatch(set, { adaptiveExpiryEnabled: val }),
