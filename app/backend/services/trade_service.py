    ...
    async def _emit_trade_result(self, trade: TradeRecord) -> None:
        ...
        await self.sio.emit(
            "trade_result",
            {
                ...
                "base_oteo_score": trade.base_oteo_score,
                "base_confidence": entry_context.get("base_confidence"),
                "level2_score_adjustment": trade.level2_score_adjustment,
                "level3_score_adjustment": entry_context.get("level3_score_adjustment"),
